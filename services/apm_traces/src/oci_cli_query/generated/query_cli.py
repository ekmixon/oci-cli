...
@cli_util.option('--apm-domain-id', required=True, help=u"""The APM Domain Id the request is intended for.""")
@cli_util.option('--time-span-started-greater-than-or-equal-to', required=True, type=custom_types.CLI_DATETIME, help=f"""Include spans that have a `spanStartTime` equal to or greater this value.{custom_types.CLI_DATETIME.VALID_DATETIME_CLI_HELP_MESSAGE}""")
@cli_util.option('--time-span-started-less-than', required=True, type=custom_types.CLI_DATETIME, help=f"""Include spans that have a `spanStartTime`less than this value.{custom_types.CLI_DATETIME.VALID_DATETIME_CLI_HELP_MESSAGE}""")
